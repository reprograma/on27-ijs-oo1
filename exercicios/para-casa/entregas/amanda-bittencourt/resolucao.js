export class SuperPoder {
 ...
 export class Personagem {
  ...
  if((this.#poderes.find(poderIncludes => poderIncludes.poder === poder.getName))) {
        console.log(
        `O poder "${poder.getName}" já existe.`);
        return
      };
 ...
 export class Confronto {
  ...
  switch (resultadoDoConfronto) {
    case 1:
      console.log(`O herói ${heroi.nome} foi o vencedor!`);
      break;
    case 2:
      console.log(`O vilão ${vilao.nome} foi o vencedor!`);
      break;
    default:
